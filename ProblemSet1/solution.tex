...
Figure~\ref{fig:dct1} and Figure~\ref{fig:dct2} show several example $8\times 8$ patches before and after 2D DCT for the two test images.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/p3_1_dct_patches.png}
  \caption{Example patches from \texttt{p3\_1.png}: spatial domain (top) and DCT magnitude (bottom).}
  \label{fig:dct1}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/p3_2_dct_patches.png}
  \caption{Example patches from \texttt{p3\_2.png}: spatial domain (top) and DCT magnitude (bottom).}
  \label{fig:dct2}
\end{figure}

\textbf{Observation:} In the DCT domain, most of the energy is concentrated in the \emph{upper-left corner} (low-frequency coefficients), especially the DC component at position $(0,0)$.  High-frequency coefficients (lower-right) tend to be near zero for smooth regions.  For \texttt{p3\_1.png} (a simpler graphic image), the energy concentration is particularly strong; \texttt{p3\_2.png} (a natural photograph with rich texture) retains more energy in mid- and high-frequency coefficients.
